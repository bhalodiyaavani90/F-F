                            ...
                            <?php
                                ...
                                <form action="slider_edit_process.php" method="post" enctype="multipart/form-data">
                                     <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="stitle" value="<?php echo $row['s_title']; ?>" id="stitle">
                                     </div>

                                     <div class="form-group">
                                            <label for="simg" class="col-form-label">Image</label>
                                            <input class="form-control" type="file" name="simg" id="simg">
                                            <img src="../upload/slider/<?php echo $row['s_img']; ?>" width="80" style="margin-top:10px;"/>
                                     </div>
										
                                     <input type="hidden" name="sid" value="<?php echo $row['s_id']; ?>">

									<div class="form-group">
                                            <input class="btn btn-success mb-3" type="submit" value="Update Slider" >
                                    </div>
                                <form>
